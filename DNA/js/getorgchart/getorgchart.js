...
getOrgChart = function (b, a) {
    this.config = {
        ...
        expandToLevel: 3,
        boxSizeInPercentage: {
            minBoxSize: {width: 5, height: 5},
            boxSize: {width: null, height: null},
            maxBoxSize: {width: 100, height: 100}
        },
        layout: null
    };
    ...
    this._aJ = null;
    this._aj = [];
    this._zf = new getOrgChart.node(-1, null, null, null, 2, 2);
    this._zj = {found: [], showIndex: 0, oldValue: "", timer: ""};
    this._aP = {};
    this._aT = null;
    this._a4 = null;
    this._zE = null;
...
getOrgChart.prototype._ae = function () {
    this._f();
    var a = getOrgChart.INNER_HTML.replace("[theme]", this.config.theme).replace("[color]", this.config.color).replace(/\[height]/g, this._a1).replace(/\[toolbar-height]/g, this.theme.toolbarHeight);
...
getOrgChart.prototype._a7 = function () {
    this._ao = [];
    this._al = [];
    this._zw = [];
    getOrgChart._T(this, this._zf, 0);
    getOrgChart._zo(this, this._zf, 0, 0, 0);
    getOrgChart._zC(this)
};
...
getOrgChart.prototype._zA = function (b, a) {
    if (this._al[a] == null) {
        this._al[a] = 0
    }
    if (this._al[a] < b.w) {
...
getOrgChart.prototype._A = function () {
    ...
    for (var a in this.nodes) {
        ...
        this._V("renderNodeEvent", {node: c, content: d});
        e.push(d.join(""));
...
getOrgChart.prototype._z = function (a) {
    ...
    for (var c = 0; c < g.length; c++) {
        ...
        h[4] = e.x;
        h[5] = e.y;
        get._z(f, {transform: b}, {transform: h}, 200, get._z._aM, function (i) {
...
getOrgChart.prototype.move = function (f, a, b) {
    ...
    if (g) {
        get._z(this._X._v, {viewBox: h}, {viewBox: e}, 300, get._z._av, function () {
            if (b) {
                b()
            }
        })
...
getOrgChart.prototype._e = function () {
    ...
    var b = "onorientationchange" in window, a = b ? "orientationchange" : "resize";
...
getOrgChart.prototype._zd = function (a, b) {
...
getOrgChart.prototype._zU = function (b, a) {
    if (!this._E) {
        this._E = {}
    }
    if (!this._E[b]) {
...
getOrgChart._X.prototype._a0 = function () {
...
getOrgChart._X.prototype._a9 = function () {
...
getOrgChart._X.prototype._zb = function (a) {
...
getOrgChart._X.prototype._zG = function (a) {
    var c;
    if (!a) {
        c = this._zD
    } else {
...
getOrgChart._zo = function (h, d, b, i, k) {
    if (b <= h.config.maxDepth) {
        ...
        if (d._N() != 0) {
            getOrgChart._zo(h, d._O(), b + 1, i + d._ap, k + c + h.config.levelSeparation)
        }
        var f = d._4();
        if (f != null) {
            getOrgChart._zo(h, f, b, i, k)
        }
    }
};
getOrgChart._zC = function (e) {
    e._zv = e._zf.x;
    e._zt = e._zf.y;
    if (e._aJ) {
...
getOrgChart.node.prototype._Z = function (a) {
    ...
    var d = [];
    var p = 0, u = 0, q = 0, v = 0, r = 0, w = 0, t = 0, x = 0;
    var f = 0, l = 0, g = 0, m = 0, h = 0, n = 0, j = 0, o = 0;
    var c = null;
...
getOrgChart.node.prototype.isCollapsed = function () {
    ...
    if (this.parent.collapsed != getOrgChart.EXPANDED) {
        return true
    } else {
...
getOrgChart.node.prototype.draw = function (a) {
    ...
    h.push(getOrgChart.OPEN_NODE.replace("[data-node-id]", this.id).replace("[x]", this._zJ == null ? this.x : this._zJ).replace("[y]", this._zM == null ? this.y : this._zM).replace("[level]", this.level).replace("[nodeCssClass]", d));
...
getOrgChart.themes = {
    ...
    ada: {
        ...
        expandCollapseBtnRadius: 20,
        box: '<rect x="0" y="0" height="220" width="550" rx="10" ry="10" class="get-box" />',
        text: '<text width="[width]" class="get-text get-text-[index]" x="[x]" y="[y]">[text]</text>',
        image: '<clipPath id="getVivianClip"><polygon class="get-box" points="20,70 75,-20 185,-20 240,70 185,160 75,160"/></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#getVivianClip)" xlink:href="[href]" x="20" y="-20" height="200" width="300"/>'
    },
    helen: {
...
getOrgChart.util._zX = function (c) {
...
getOrgChart.util._a5 = function (b, a) {
    var c = b.getBoundingClientRect();
...
getOrgChart.util._aW = function (a, b, c) {
...
getOrgChart.util._zV = function (b, a) {
    var c = b.getBoundingClientRect();
    var d = a.touches[0].pageX - c.left;
    var f = a.touches[0].pageY - c.top;
...
getOrgChart.prototype.showDetailsView = function (d) {
    ...
    get._z(this._X._m, {opacity: 0}, {opacity: 1}, 400, get._z._aL);
    get._z(this._X._zF, {top: 0}, {top: -j}, 200, get._z._aL);
    get._z(this._X._i, {opacity: 0}, {opacity: 1}, 200, get._z._ag)
};
...
getOrgChart.prototype._zg = function (e, a) {
    if (this._S) {
...
getOrgChart.prototype.showGridView = function () {
    ...
    get._z(this._X._9, {left: 100, opacity: 0}, {left: 0, opacity: 1}, 200, get._z._aK);
    get._z(this._X._zF, {top: 0}, {top: -this.theme.toolbarHeight * 2}, 200, get._z._aL)
};
...
getOrgChart.prototype.showMainView = function () {
    ...
    if (this._X._zF.style.top != 0 && this._X._zF.style.top != "" && this._X._zF.style.top != "0px") {
        get._z(this._X._zF, {top: -46}, {top: 0}, 200, get._z._aL)
    }
};
...
getOrgChart.prototype.print = function () {
    var b = this, d = this._X.element, k = this._X._zR, g = [], h = d.parentNode, j = k.style.display,
        a = document.body, c = a.childNodes, e;
    if (b._ay) {
        return
    }
    b._ay = true;
...
getOrgChart.prototype._zu = function (d, b) {
    this._X._n = undefined;
    var a = b[0].wheelDelta ? b[0].wheelDelta / 40 : b[0].detail ? -b[0].detail : 0;
    if (a) {
        var e = a > 0;
        var c = getOrgChart.util._aW(this._X._v, b[0].pageX, b[0].pageY);
        this.zoom(e, false, c)
    }
...
getOrgChart.prototype._aA = function (g, b) {
    this._X._n = undefined;
    ...
    if (this.config.enableMove) {
        ...
        function h() {
            get._z(i._X._zr, {right: -30, opacity: 0}, {right: 1, opacity: 0.8}, 500, get._z._ax);
            get._z(i._X._am, {left: -30, opacity: 0}, {left: 1, opacity: 0.8}, 500, get._z._ax);
            get._z(i._X._zB, {top: 19, opacity: 0}, {top: 49, opacity: 0.8}, 500, get._z._ax);
            get._z(i._X._Q, {bottom: -30, opacity: 0}, {bottom: 1, opacity: 0.8}, 500, get._z._ax)
        }

        function d() {
            get._z(i._X._zr, {right: 1, opacity: 0.8}, {right: -30, opacity: 0}, 500, get._z._ax, function () {
                i._aE = null
            });
            get._z(i._X._am, {left: 1, opacity: 0.8}, {left: -30, opacity: 0}, 500, get._z._ax, function () {
                i._aE = null
            });
            get._z(i._X._zB, {top: 49, opacity: 0.8}, {top: 19, opacity: 0}, 500, get._z._ax, function () {
                i._aE = null
            });
            get._z(i._X._Q, {bottom: 1, opacity: 0.8}, {bottom: -30, opacity: 0}, 500, get._z._ax, function () {
                i._aE = null
            })
        }
...
getOrgChart.prototype._aZ = function (b, a) {
...
getOrgChart.prototype.zoom = function (c, a, b) {
    ...
    if (a) {
        get._z(this._X._v, {viewBox: f}, {viewBox: j}, 300, get._z._aM, function () {
            i._zI = false
        })
    } else {
        this._X._v.setAttribute("viewBox", j.toString());
...
getOrgChart.prototype._zi = function (c, b) {
    var a = this;
    clearTimeout(this._zj.timer);
    this._zj.timer = setTimeout(function () {
...
getOrgChart.prototype._zk = function (c, b) {
    var a = this;
    clearTimeout(this._zj.timer);
    this._zj.timer = setTimeout(function () {
        a._zj.currentIndex = 0;
...
getOrgChart.prototype.highlightNode = function (c) {
    ...
    function b() {
        ...
        a.move([f, g, a.initialViewBoxMatrix[2], a.initialViewBoxMatrix[3]], null, function () {
            ...
            get._z(i, {transform: h}, {transform: j}, 200, get._z._ag, function (k) {
                get._z(k[0], {transform: j}, {transform: h}, 200, get._z._aL, function () {
                })
            })
        })
    }
...
getOrgChart.prototype._au = function (a) {
};
...
getOrgChart.prototype._F = function (g) {
    ...
    for (var b in this.nodes) {
        ...
        for (m in f.data) {
            ...
            var c = -1;
            if (getOrgChart.util._ab(f) && getOrgChart.util._ab(f.data[m])) {
                var d = f.data[m].toString().toLowerCase();
                c = d.indexOf(g)
            }
            if (c > -1) {
                e.push({indexOf: c, node: f});
                break
            }
        }
    }
...
getOrgChart.prototype._aB = function (g, a) {
...
getOrgChart.prototype._aG = function (i, c) {
    var b = c[0];
    b.preventDefault();
    this._aB(i, c);
...
getOrgChart.prototype._zp = function (a, d, e, c) {
    var b = this._X.getButtonByType(a);
    b.style.display = "block";
    b.setAttribute("transform", "matrix(0.14,0,0,0.14," + d + "," + e + ")");
    b.setAttribute("data-btn-id", c)
};
getOrgChart.prototype._aV = function (d, a) {
    var b = d.getAttribute("data-node-id");
    var c = this.nodes[b];
    if (!this._V("clickNodeEvent", {node: c})) {
        return
    }
};
getOrgChart.prototype._aF = function (d, b) {
    b[0].preventDefault();
...
getOrgChart.prototype.expandOrCollapse = function (a) {
    var c = this;
    var b = this.nodes[a];
    this._aJ = {id: a, old_x: b.x, old_y: b.y};
...
getOrgChart.prototype.insertNode = function (d, a, b) {
    var f = this;
    var e = this.nodes[d];
    this._aJ = {id: d, old_x: e.x, old_y: e.y};
    if (b == undefined) {
        b = getOrgChart.util._G(this.nodes)
    }
    ...
    if (!this._V("insertNodeEvent", {node: c})) {
...
getOrgChart.prototype.removeNode = function (b) {
    var e = this;
    if (!this._V("removeNodeEvent", {id: b})) {
        return
    }
    var a = this.nodes[b];
    var d = a.parent;
...
getOrgChart.prototype.updateNode = function (b, d, a) {
    ...
    c.pid = d;
    c.data = a;
    if (this._V("updateNodeEvent", {node: c})) {
        this.loadFromJSON(this.nodes, true, function () {
            e._V("updatedEvent")
        })
    }
...
getOrgChart.prototype._h = function (d, f, g, c, a, b) {
    ...
    if (!this._V("createNodeEvent", {node: e})) {
        return null
    }
    if (this.nodes[d]) {
    ...
    this.nodes[d] = e;
    for (label in e.data) {
        if (!getOrgChart.util._s(this._aj, label)) {
            this._aj.push(label)
        }
    }
    return e
...
getOrgChart.prototype.exportToImage = function () {
    ...
    width = j;
    height = k;
    var s = (l - this.config.subtreeSeparation) + "," + (m) + "," + (j + this.theme.size[0] + this.config.subtreeSeparation * 2) + "," + (k + this.theme.size[1]);
    o._X._v.setAttribute("viewBox", s);
    var r = "png";
    ...
    function q(v) {
        var u = new MouseEvent("click", {view: window, bubbles: false, cancelable: true});
        var t = document.createElement("a");
        t.setAttribute("download", "getorgchart.png");
    ...
    setTimeout(function () {
        get._a._B(f, null, function (t) {
            ...
            u = u.replace("<svg", '<svg width="' + width + '" height="' + height + '" ').replace("<defs/>", '<defs/><g class="' + o._X._zY.className + '"><g class="get-oc-tb"><g class="get-oc-c">').replace("</defs>", '</defs><g class="' + o._X._zY.className + '"><g class="get-oc-tb"><g class="get-oc-c">').replace("<defs/>", '<defs><style type="text/css">' + t + "</style></defs>").replace("</defs>", '<style type="text/css">' + t + "</style></defs>").replace("</svg>", "</g></g></g></svg>");
            var v = window.URL || window.webkitURL || window;
            var w = new Image();
            var x = new Blob([u], {type: "image/svg+xml;charset=utf-8"});
            var y = v.createObjectURL(x);
            w.onload = function () {
                c.drawImage(w, 0, 0);
                v.revokeObjectURL(y);
                var z = a.toDataURL("image/png").replace("image/png", "image/octet-stream");
                q(z)
            };
            w.src = y
        })
                ...
                for (z = n.children.length - 1; z >= 0; z--) {
                    ...
                    if (b.children.length == 0 && b != this.nodes[j] && b.displayPid == null && b.displayChildren == null) {
                        if (this.nodes[j].color == null) {
                            this.nodes[j].color = getOrgChart.util._3(this.config.color)
                        }
...
getOrgChart.prototype.loadFromXMLDocument = function (b) {
    var a = [];
    var c = getOrgChart.util._zX(b);
    this._ak = 0;
    this._ai(c, null, true, a);
    this.loadFromJSON(a)
};
getOrgChart.prototype._ai = function (m, l, d, h) {
    var a = this;
    if (m.nodeType == 1) {
...
getOrgChart.prototype._y = function (d, b) {
    ...
    if (b[0].touches.length == 2) {
        this._aP.dragStart = null;
        this._p = null;
        this._a4 = getOrgChart.util._a3(this._X._v, a)
    }
};
getOrgChart.prototype._b = function (j, d) {
    ...
    if (d[0].touches.length == 2) {
        var b = getOrgChart.util._a3(this._X._v, d[0]);
        var k = 1 + ((b - this._a4) / (this._a4 / 100)) / 100;
        var i = getOrgChart.util._a5(this._X._v, d[0]);
        this.zoom(k, null, i);
        this._a4 = b
    }
};
...
getOrgChart.prototype._aU = function (i, c) {
    var b = c[0];
    this._aV(i, c);
    this._aB(i, c);
    var h = new Date().getTime();
...
getOrgChart.prototype._aN = function (c, b) {
    var a = b[0];
    a.preventDefault()
};
getOrgChart.prototype._aH = function (c, b) {
    var a = b[0];
